var wrapper = new Vue({
    ...
    mounted:function () {
        ...
        //否则读取浏览器缓存
            ...
            this.showItems = getLocalStorage("contract");
        }
    },
    methods:{
        ...
        confirm:function () {
            ...
            storeJson(this.showItems,"contract");
            this.index = -1;
            this.selected = null;
            this.show = false;
        },
